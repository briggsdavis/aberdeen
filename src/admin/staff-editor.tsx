        ...
        <aside className="sticky top-6 grid gap-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">Edit or change the display order.</p>
            </div>
            <button
          ...
          <div className="grid gap-2">
            {orderedMembers.map((member, index) => (
              <article
                className="group flex items-center gap-3 rounded-lg border border-slate-200 p-2.5 transition hover:border-aberdeen-blue/25 hover:bg-slate-50"
                key={member._id}
              >
                <img
                  alt=""
                ...
                <div className="flex items-center">
                  <button
                    aria-label="Move up"
                    className="p-1.5 text-slate-400 hover:text-aberdeen-blue disabled:opacity-25"
                    disabled={index === 0}
                  ...
                  <button
                    aria-label="Edit"
                    className="p-1.5 text-slate-400 hover:text-aberdeen-blue"
                    onClick={() =>
                      setEditing({
                        id: member._id,
                        name: member.name,
      ...
      {editing ? (
        ...
        >
          <div className="grid gap-4">
            <button
              className="group relative h-44 overflow-hidden rounded-xl border border-dashed border-slate-300 bg-slate-50"
            ...
            >
              {editing.image ? (
                ...
                <span className="text-sm text-slate-500">Choose a portrait</span>
              )}
